    ...
    return ( 
       ...
       <section className="bg-white w-screen h-screen">
                <div className="flex items-center justify-center h-full">
                    <div className="w-[331px] h-[374px] border flex justify-center items-center">
                    <form className="space-y-4 md:space-y-6" action="#">
                      ...
                      <button type="submit" className="w-[252px] h-10 text-white text-xl font-medium leading-6 tracking-normal text-center font-family: Inter bg-[linear-gradient(92.08deg,#02B9E1_50%,#01CAF7_85.26%)] rounded-full flex justify-center items-center">Login</button>
                      <p className="text-base font-normal leading-[19px] text-[#7A7A7A] tracking-normal text-center font-family: Inter">you dont have an account ?? </p>
                      <Link to = "/Signup" className="text-base font-normal leading-[19px] tracking-normal text-center font-family: Inter text-[linear-gradient(87.46deg,#970176_0%,#10D0FB_143.76%)]">Signup</Link>
                    </form>
                    </div>
                </div>
        </section>
